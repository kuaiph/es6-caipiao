...
var Base = function () {
   ...
   */
		...
		value: function changePlayNav(e) {
			...
			(0, _jquery2.default)('.bool-list .btn-boll').removeClass('btn-boll-active');
			self.getCount();
		}
		/**
   * [assistHandle 操作区]
   ...
   */
		...
		value: function getRandom(num) {
			var arr = [],
			    index = void 0;
			var number = Array.from(this.number); //set集合转成真正的数组
			while (num--) {
...
var Calculate = function () {
   ...
   */
		value: function computeCount(active, play_name) {
			...
			var arr = new Array(active).fill('0'); //长度active 的'0'数组
...
var Interface = function () {
   ...
   */
		value: function getOmit(issue) {
			var self = this; //涉及闭包 要保留对this的引用
			return new Promise(function (resolve, reject) {
				//传统方式使用回调
